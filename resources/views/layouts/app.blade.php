...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/logos/logo-icon.png') }}"/>
    <!-- Fonts -->
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark {!! Route::current()->uri == '/' ? 'remove-mb' : '' !!}">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('images/logos/logo-full.png') }}" class="app-logo-full">
                </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="/" class="dropdown-item user-menu">
                                        <div class="row">
                                            <div class="col-md-1"><span class="fa fa-user-circle-o mr-2"></span></div>
                                            <div class="col-md-6 pl-2">Profile</div>
                                        </div>
                                    </a>
